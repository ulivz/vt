...
function resolvePath(relative: string, base: string, append = false) {
 ...
 * @returns { SidebarGroup }
 */
function resolveHeaders(page: any): any {
...
function resolveItem(item: any, pages: any[], base: string, groupDepth = 1) {
